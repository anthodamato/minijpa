...
public class QueryLevelTest {
    ...
    public void embedManyToOne() throws Exception {
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("embed_many_to_one",
        ...
        MetaEntity metaEntityJE = persistenceUnitEnv.getPersistenceUnitContext().getEntities()
                .get("org.minijpa.jpa.model.JobEmployee");
    ...
    public void oneToOneBidLazy() throws Exception {
        ...
        MetaEntity metaEntityState = persistenceUnitEnv.getPersistenceUnitContext().getEntities()
                .get("org.minijpa.jpa.model.State");
        MetaEntity metaEntityCapital = persistenceUnitEnv.getPersistenceUnitContext().getEntities()
    ...
    public void oneToOneBid() throws Exception {
        ...
        MetaEntity metaEntityPerson = persistenceUnitEnv.getPersistenceUnitContext().getEntities()
                .get("org.minijpa.jpa.model.Person");
        MetaEntity metaEntityFingerprint = persistenceUnitEnv.getPersistenceUnitContext().getEntities()
