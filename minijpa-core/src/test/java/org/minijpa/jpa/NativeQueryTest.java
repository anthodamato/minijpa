...
public class NativeQueryTest {
	...
	public void nativeQuery() throws Exception {
		...
		Assertions.assertTrue(citizens.get(0).getName().equals("Peter") || citizens.get(1).getName().equals("Peter"));
		Assertions.assertTrue(citizens.get(0).getName().equals("Emily") || citizens.get(1).getName().equals("Emily"));
