...
public class OneToManyHelper extends RelationshipHelper {
    ...
    public OneToManyRelationship createOneToMany(OneToMany oneToMany, Class<?> collectionClass, Class<?> targetEntity,
    ...
    private JoinTableAttributes createJoinTableAttributes(Relationship relationship, MetaEntity entity,
            MetaEntity toEntity) {
    ...
    public OneToManyRelationship finalizeRelationship(OneToManyRelationship oneToManyRelationship, MetaAttribute a,
        ...
        if (oneToManyRelationship.isOwner()) {
            if (oneToManyRelationship.getJoinColumnDataList().isPresent()) {
                ...
                JoinColumnMapping joinColumnMapping = joinColumnMappingFactory.buildJoinColumnMapping(dbConfiguration,
                ...
                JoinTableAttributes joinTableAttributes = createJoinTableAttributes(oneToManyRelationship, entity,
                        toEntity);
                ...
                RelationshipJoinTable relationshipJoinTable = new RelationshipJoinTable(joinTableAttributes.getSchema(),
            ...
            MetaAttribute owningAttribute = AttributeUtil
