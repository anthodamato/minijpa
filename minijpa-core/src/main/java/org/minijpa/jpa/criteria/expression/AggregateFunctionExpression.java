...
public class AggregateFunctionExpression<N extends Number> implements Expression<N>,
    AggregateFunctionTypeInfo {
  ...
  public AggregateFunctionExpression(AggregateFunctionType aggregateFunctionType, Expression<N> x,
      boolean distinct) {
    super();
