 ...
 * @author adamato
 */
public class EntityLoaderImpl implements JpaEntityLoader {
...
//	LOG.debug("findById: primaryKey={}", primaryKey);
        Optional<?> optional = entityQueryLevel.run(metaEntity, primaryKey, lockType);
        if (optional.isEmpty())
            return null;
...
//	}
    ...
    public Object queryVersionValue(MetaEntity metaEntity, Object primaryKey, LockType lockType) throws Exception {
        Optional<?> optional = entityQueryLevel.runVersionQuery(metaEntity, primaryKey, lockType);
        if (optional.isEmpty())
            return null;

        ModelValueArray<FetchParameter> modelValueArray = (ModelValueArray<FetchParameter>) optional.get();
//        ModelValueArray<FetchParameter> modelValueArray = entityQueryLevel.runVersionQuery(metaEntity, primaryKey,
//                lockType);
//        if (modelValueArray == null)
//            return null;
