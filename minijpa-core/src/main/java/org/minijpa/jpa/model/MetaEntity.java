...
public class MetaEntity {
   ...
   * Basic attributes
   */
  private List<MetaAttribute> basicAttributes = Collections.unmodifiableList(
      Collections.emptyList());
  private List<RelationshipMetaAttribute> relationshipAttributes = Collections.emptyList();
