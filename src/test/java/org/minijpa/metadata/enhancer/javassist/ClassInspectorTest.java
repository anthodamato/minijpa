...
public class ClassInspectorTest {
	...
	public void mappedSuperclass() throws Exception {
		...
		List<String> classNames = Arrays.asList("org.minijpa.jpa.model.TriangleAttrs", "org.minijpa.jpa.model.Square");
		List<ManagedData> managedDatas = new ArrayList<>();
		ManagedData managedData = ci.inspect("org.minijpa.jpa.model.TriangleAttrs", new ArrayList<ManagedData>());
		managedDatas.add(managedData);

//		List<ManagedData> managedDatas = ci.inspect(classNames);
		managedData = ci.inspect("org.minijpa.jpa.model.Square", new ArrayList<ManagedData>());
		managedDatas.add(managedData);
