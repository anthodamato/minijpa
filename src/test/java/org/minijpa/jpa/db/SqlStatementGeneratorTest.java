...
public class SqlStatementGeneratorTest {
	...
	String d1 = ddlStatements.get(1);
	Assertions.assertEquals("create sequence SEQ_GEN_SEQUENCE start with 1 increment by 1", d1);
	String d2 = ddlStatements.get(2);
	Assertions.assertEquals("create table Address (id bigint generated by default as identity, name varchar(255), postcode varchar(255), tt boolean not null, primary key (id))", d2);
    }
