...
import org.minijpa.jdbc.relationship.ManyToOne;
import org.minijpa.jdbc.relationship.OneToMany;
import org.minijpa.jdbc.relationship.OneToOne;
...
//		pkSequenceGenerator.setInitialValue(sequenceGenerator.initialValue());
    ...
    /**
     * It's a post-processing step needed to complete entity data. For example, filling out the
     * 'join column' one to one relationships if missing.
     *
    ...
    /**
     * @TODO Should be read using the bytecode manipulation tool. This is the case of attribute type
     * already set. For example: <code>
     * &#64;OneToMany(mappedBy = "department") private Collection<Employee> employees = new
     * HashSet<>();
     * </code>
     *
