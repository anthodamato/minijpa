...
public abstract class BasicDbJdbc implements DbJdbc {
	...
	return buildColumnDefinition(joinColumnAttribute.getReadWriteDbType(), Optional.empty());
    }

    @Override
    public String buildIdentityColumnDefinition(MetaAttribute metaAttribute) {
	return buildColumnDefinition(metaAttribute.getReadWriteDbType(), metaAttribute.getDdlData()) + " generated by default as identity";
    }
