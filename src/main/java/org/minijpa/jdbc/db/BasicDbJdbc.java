...
public abstract class BasicDbJdbc implements DbJdbc {
	...
	public String buildColumnDefinition(MetaAttribute metaAttribute) {
		return buildColumnDefinition(metaAttribute.getDatabaseType(), metaAttribute.getDdlData());
	}
	...
	public String buildIdentityColumnDefinition(MetaAttribute metaAttribute) {
		return buildColumnDefinition(metaAttribute.getDatabaseType(), metaAttribute.getDdlData()) + " generated by default as identity";
	}
