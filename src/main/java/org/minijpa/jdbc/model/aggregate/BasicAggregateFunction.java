...
public class BasicAggregateFunction implements AggregateFunction, Value {
	...
	private final AggregateFunctionType aggregateFunctionBasicType;
	private Optional<TableColumn> tableColumn = Optional.empty();
	private boolean distinct = false;
	private Optional<String> expression = Optional.empty();

	public BasicAggregateFunction(AggregateFunctionType aggregateFunctionBasicType, TableColumn tableColumn, boolean distinct) {
		super();
	...
	public BasicAggregateFunction(AggregateFunctionType aggregateFunctionBasicType, String expression, boolean distinct) {
		super();
		this.aggregateFunctionBasicType = aggregateFunctionBasicType;
